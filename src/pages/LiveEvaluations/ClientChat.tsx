...
const ClientChat=()=>{
  ...
  return (
    <div className="flex flex-auto flex-col justify-center flex items-center h-screen py-4 bg-gray-800">
      {/* <div className="mb-8">
        <Header>Client Chat</Header>
      </div> */}
      {/* h-[700px] w-[1000px] */}
      <Card className="flex flex-col h-10/12 bg-gray-800 border-none"> 
         <CardHeader className="basis-3/12">
            <div className="flex grow  items-center bg-gray-800 border-none">
                <h1 className="text-white text-3xl">Client Chat</h1>
            </div> 
        </CardHeader> 
        ...
        <CardFooter className="flex p-1">
            <form className="flex grow" onSubmit={handleSubmit(sendMessage)}>
                ...
                className="flex-1 mr-2 text-white bg-gray-600 border-none"
